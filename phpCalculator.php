...
$mailSMTP = new SendMailSmtpClass('azatmagdeev@yandex.ru', 'akbaj22443226!', 'ssl://smtp.yandex.ru', 'Evgeniy'); // создаем экземпляр класса
...
$result =  $mailSMTP->send('azatmagdeev@gmail.com', 'Тема письма', $mes, $headers); // отправляем письмо
...
//);
//
///*s*/echo 'azat</br>$result=<pre>'.print_r($result, true)."</pre>"; //todo remove it
