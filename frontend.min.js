...
!function (e) {
  ...
  "use strict";
  var i = n(10), r = n(12), o = n(13), a = n(8), s = n(77), l = n(122).KEY, u = n(25), c = n(53), d = n(55), f = n(35),
    p = n(16), h = n(56), g = n(57), v = n(123), m = n(95), y = n(18), b = n(17), _ = n(31), S = n(15), w = n(49),
    k = n(30), x = n(51), E = n(124), C = n(38), O = n(64), M = n(14), D = n(28), $ = C.f, T = M.f, A = E.f,
    I = i.Symbol, P = i.JSON, j = P && P.stringify, V = p("_hidden"), F = p("toPrimitive"), L = {}.propertyIsEnumerable,
    H = c("symbol-registry"), R = c("symbols"), B = c("op-symbols"), Q = Object.prototype,
    N = "function" == typeof I && !!O.f, G = i.QObject, z = !G || !G.prototype || !G.prototype.findChild,
    U = o && u(function () {
      return 7 != x(T({}, "a", {
        get: function () {
    ...
    return (0, u.default)(baseTabs, e), (0, o.default)(baseTabs, [{
      ...
      key: "activateDefaultTab", value: function activateDefaultTab() {
        ...
        if (e.autoExpand && ("editor" !== e.autoExpand || this.isEdit)) {
          var t = this.getEditSettings("activeItemIndex") || 1, n = {showTabFn: e.showTabFn, hideTabFn: e.hideTabFn};
      ...
      key: "activateTab", value: function activateTab(e) {
        var t = this.getSettings(), n = t.classes.active, i = this.elements.$tabTitles.filter('[data-tab="' + e + '"]'),
    ...
    return (0, u.default)(BackgroundSlideshow, e), (0, o.default)(BackgroundSlideshow, [{
      ...
      key: "buildSwiperElements", value: function buildSwiperElements() {
        var e = this, t = this.getSettings("classes"), n = this.getElementSettings(),
          ...
          r = jQuery("<div>", {class: t.swiperContainer, dir: i}), o = jQuery("<div>", {class: t.swiperWrapper}),
          a = n.background_slideshow_ken_burns, s = t.swiperSlideInner;
        if (a) {
          s += " " + t.kenBurns;
  ...
  "use strict";
  var i = n(0), r = i(n(484)), o = i(n(485)), a = i(n(486)), s = i(n(487)), l = i(n(488)), u = i(n(489)), c = i(n(490)),
    d = i(n(491)), f = i(n(492)), p = i(n(493)), h = i(n(498)), g = i(n(499));
  e.exports = function (e) {
    var t = this, n = {
      section: p.default,
      column: h.default,
    ...
    return (0, u.default)(BackgroundVideo, e), (0, o.default)(BackgroundVideo, [{
      ...
      key: "calcVideosSize", value: function calcVideosSize(e) {
        ...
        var n = this.elements.$backgroundVideoContainer.outerWidth(),
          i = this.elements.$backgroundVideoContainer.outerHeight(), r = t.split(":"), o = r[0] / r[1], a = n / i > o;
      ...
      key: "prepareVimeoVideo", value: function prepareVimeoVideo(e, t) {
        var n = this, i = this.getElementSettings(), r = i.background_video_start ? i.background_video_start : 0, o = {
          id: t,
  ...
  n(26), n(161), n(98), n(80), e.exports = elementorModules.ViewModule.extend({
    ...
    setSlideshowContent: function setSlideshowContent(e) {
      var t = jQuery, n = this, i = n.getSettings("classes"), r = i.slideshow, o = t("<div>", {class: r.container}),
    ...
    playSlideVideo: function playSlideVideo() {
      ...
      if (n) {
        var i, r, o = this.getSettings("classes"), a = jQuery("<div>", {class: o.videoContainer + " " + o.invisible}),
